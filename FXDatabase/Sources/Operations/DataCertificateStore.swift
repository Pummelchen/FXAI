...
public struct DataCertificateStore: Sendable {
    ...
    private func loadCoverageRows(
        ...
        SELECT mt5_symbol, timeframe, mt5_range_start, mt5_range_end_exclusive,
               ...
               batch_id, verified_at_utc, source_origin
    ...
    private func buildCertificate(
        ...
        var hasher = SHA256ChunkHasher(namespace: "fxdatabase_m1_data_certificate")
        hasher.appendField("broker_source_id", brokerSourceId.rawValue)
        hasher.appendField("source_origin", sourceOrigin.rawValue)
        ...
        for (index, row) in rows.enumerated() {
            ...
            hasher.appendField("source_origin", row.sourceOrigin.rawValue)
    ...
    private func insert(_ certificate: DataCertificate, rows: [CoverageCertificateRow], createdAtUtc: UtcSecond) async throws {
        ...
        let fields = [
            ...
            tsv(certificate.sourceOrigin.rawValue),
            ...
            tsv(ChunkHashSchemaVersion.current),
        ...
        (broker_source_id, source_origin, logical_symbol, timeframe,
...
private struct CoverageCertificateRow: Sendable {
    ...
    static func parse(_ row: String) throws -> CoverageCertificateRow {
        ...
        guard fields.count == 14,
              ...
              let verifiedAtUtc = Int64(fields[12]),
              let sourceOrigin = DataSourceOrigin(rawValue: fields[13]) else {
