...
public enum OperationalFailureGuide {
    ...
    public static let scenarioCatalog: [OperationalRecoveryAdvice] = [
        ...
        scenario(
            ...
            steps: ["Start MT5 under Wine.", "Attach FXDatabase.", "Match SwiftHost/SwiftPort to Config/mt5_bridge.json.", "Enable Algo Trading and localhost sockets."],
        ...
        scenario(
            ...
            steps: ["Confirm MT5 and MetaEditor are installed.", "Set FXDATABASE_METAEDITOR, FXDATABASE_WINE, or FXDATABASE_WINEPREFIX only when the default toolchain cannot be found.", "Rerun startcheck after the EA compiles cleanly."],
        ...
        scenario(
            ...
            commands: ["ps aux | grep FXDatabase"]
        ),
        scenario(
            code: "OS-001",
