...
public enum DomainError: Error, Equatable, CustomStringConvertible, Sendable {
    ...
    case emptyDataSourceOrigin
    case invalidLogicalSymbol(String)
    case invalidDataSourceOrigin(String)
    case emptyMT5Symbol
    ...
    public var description: String {
        ...
        case .emptyDataSourceOrigin:
            return "Data source origin is empty."
        case .invalidLogicalSymbol(let value):
            return "Logical symbol '\(value)' must be uppercase letters/numbers only."
        case .invalidDataSourceOrigin(let value):
            return "Data source origin '\(value)' must be uppercase letters, numbers, underscore, or hyphen only."
        case .emptyMT5Symbol:
