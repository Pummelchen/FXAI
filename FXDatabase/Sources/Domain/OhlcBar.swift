...
public struct BatchId: RawRepresentable, Codable, Hashable, Sendable, CustomStringConvertible {
    ...
    public static func deterministic(
        ...
        BatchId(rawValue: "\(brokerSourceId.rawValue):\(sourceOrigin.rawValue):\(logicalSymbol.rawValue):\(start.rawValue):\(end.rawValue)")
    }
}
...
public enum SourceStatus: String, Codable, Hashable, Sendable {
    ...
    public var isCanonicalClosedM1Bar: Bool {
        switch self {
        case .closedM1Bar, .mt5ClosedBar:
            return true
        case .unresolvedUtcOffset, .invalid:
            return false
        }
    }
}
...
public struct CanonicalBar: Codable, Hashable, Sendable {
    ...
    public init(from validatedBar: ValidatedBar) {
        self.sourceOrigin = validatedBar.sourceOrigin
        ...
        self.volume = validatedBar.volume
