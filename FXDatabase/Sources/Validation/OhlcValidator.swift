...
public enum ValidationError: Error, Equatable, CustomStringConvertible, Sendable {
    ...
    case unexpectedSourceOrigin(DataSourceOrigin)
    ...
    public var description: String {
        ...
        case .unexpectedSourceOrigin(let sourceOrigin):
            return "Unexpected data source origin \(sourceOrigin.rawValue)."
...
public struct OhlcValidationContext: Sendable {
    ...
    public let expectedSourceOrigin: DataSourceOrigin
    ...
    public init(
        ...
        expectedSourceOrigin: DataSourceOrigin = .mt5,
        ...
        sourceStatus: SourceStatus = .mt5ClosedBar
    ) {
        self.brokerSourceId = brokerSourceId
        self.expectedSourceOrigin = expectedSourceOrigin
...
public struct OhlcValidator: Sendable {
    ...
    public func validate(_ bar: ClosedM1Bar, context: OhlcValidationContext) throws -> ValidatedBar {
        ...
        guard bar.sourceOrigin == context.expectedSourceOrigin else {
            throw ValidationError.unexpectedSourceOrigin(bar.sourceOrigin)
        }
