...
public struct VerifiedCoverageRecord: Sendable {
    ...
    public init(
        ...
        self.canonicalRowCount = canonicalRowCount
        self.sourceHash = sourceHash
        self.hashSchemaVersion = hashSchemaVersion
        self.mt5SourceSHA256 = mt5SourceSHA256
        self.canonicalReadbackSHA256 = canonicalReadbackSHA256
        self.offsetAuthoritySHA256 = offsetAuthoritySHA256
...
public struct IngestAuditStore: Sendable {
    ...
    public func recordOperation(
        ...
        fields.append(tsv(sourceOrigin.rawValue))
        ...
        INSERT INTO \(database).ingest_operations (
            broker_source_id, source_origin, logical_symbol, mt5_symbol, timeframe, operation_type,
    ...
    public func recordVerifiedCoverage(_ record: VerifiedCoverageRecord) async throws {
        let row = [
            ...
            tsv(record.sourceOrigin.rawValue),
        ...
        INSERT INTO \(database).ohlc_m1_verified_coverage (
            broker_source_id, source_origin, logical_symbol, mt5_symbol, timeframe,
