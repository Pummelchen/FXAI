...
public enum ChunkHashing {
    public static let schemaVersion = ChunkHashSchemaVersion.current
    ...
    public static func mt5SourceSHA256(response: RatesResponseDTO, manifest: MT5RangeManifest) -> SHA256DigestHex {
        ...
        hasher.appendField("source_origin", DataSourceOrigin.mt5.rawValue)
        ...
        for (index, rate) in response.rates.enumerated() {
            ...
            hasher.appendField("volume", Int64(M1Volume.zero.rawValue))
        }
    ...
    public static func canonicalSHA256(
        ...
        hasher.appendField("source_origin", rows.first?.sourceOrigin.rawValue ?? DataSourceOrigin.mt5.rawValue)
        ...
        for (index, row) in rows.enumerated() {
            ...
            hasher.appendField("volume", Int64(bitPattern: row.volume.rawValue))
