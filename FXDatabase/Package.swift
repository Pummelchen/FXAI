...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "Ingestion", dependencies: ["Domain", "AppCore", "Config", .product(name: "MT5Bridge", package: "FXImporter"), "ClickHouse", "TimeMapping", "Validation"]),
        ...
        .executableTarget(
            name: "FXDatabaseCLI",
            dependencies: ["AppCore", "Config", .product(name: "MT5Bridge", package: "FXImporter"), "ClickHouse", "Ingestion", "Verification", "BacktestCore", "MetalAccel", "TimeMapping", "Operations", "FXBacktestAPIServer"]
        ),
        ...
        .testTarget(name: "IngestionTests", dependencies: ["Domain", "Ingestion", "ClickHouse", .product(name: "MT5Bridge", package: "FXImporter"), "TimeMapping"]),
