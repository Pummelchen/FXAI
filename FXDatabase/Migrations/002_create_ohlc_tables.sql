...
ORDER BY (broker_source_id, source_origin, logical_symbol, ts_utc, batch_id);
...
ENGINE = MergeTree
PARTITION BY toYYYYMM(toDateTime(ts_utc, 'UTC'))
ORDER BY (broker_source_id, source_origin, logical_symbol, ts_utc);
