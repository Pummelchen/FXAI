...
ORDER BY (broker_source_id, source_origin, logical_symbol, batch_id, event_at_utc, status_rank);
...
ORDER BY (broker_source_id, source_origin, logical_symbol, utc_range_start, utc_range_end_exclusive, verified_at_utc);
