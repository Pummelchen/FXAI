...
ORDER BY (broker_source_id, source_origin, logical_symbol);
...
ORDER BY (broker_source_id, source_origin, logical_symbol, checked_at_utc);
...
ORDER BY (broker_source_id, source_origin, logical_symbol, created_at_utc);
