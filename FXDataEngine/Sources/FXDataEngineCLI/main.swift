...
struct FXDataEngineCLI {
    static func main() throws {
        ...
        print("FXDataEngine API v\(FXDataEngineConstants.latestPluginAPIVersion) features=\(FXDataEngineConstants.aiFeatures) weights=\(FXDataEngineConstants.aiWeights) maxSequenceBars=\(FXDataEngineConstants.maxSequenceBars)")
