...
- GUI operator surface:
  - `<FXAI_ROOT>/FXGUI/Sources/FXGUICore/Models/NewsPulseModels.swift`
  - `<FXAI_ROOT>/FXGUI/Sources/FXGUICore/Services/NewsPulseArtifactReader.swift`
  - `<FXAI_ROOT>/FXGUI/Sources/FXGUIApp/Features/NewsPulse/NewsPulseView.swift`
  - `<FXAI_ROOT>/FXGUI/Sources/FXGUICore/Services/IncidentBuilder.swift`
