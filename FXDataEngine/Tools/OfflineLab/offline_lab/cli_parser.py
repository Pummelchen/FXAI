...
def build_parser() -> argparse.ArgumentParser:
    ...
    drq = sub.add_parser("drift-retraining-queue", help="Queue research-only retraining requests from current drift-governance state")
    drq.add_argument("--profile", default="continuous")
    drq.add_argument("--symbol", default="")
    drq.add_argument("--plugin", default="")
    drq.add_argument("--min-risk-score", type=float, default=0.56)
    drq.add_argument("--include-low-support", action="store_true")
    drq.add_argument("--data-days", type=int, default=90)
    drq.add_argument("--months-list", default="")
    drq.add_argument("--wf-train-years", default="1,2,3,5")
    drq.add_argument("--scenario-list", default=SERIOUS_SCENARIOS)
    drq.set_defaults(func=cmd_drift_retraining_queue)

    drr = sub.add_parser("drift-retraining-report", help="Rebuild the drift-triggered retraining report from queued requests")
    drr.add_argument("--profile", default="continuous")
    drr.add_argument("--symbol", default="")
    drr.set_defaults(func=cmd_drift_retraining_report)

    dre = sub.add_parser("drift-retraining-execute", help="Run explicit research-only retraining campaigns for queued drift requests")
    dre.add_argument("--profile", default="continuous")
    dre.add_argument("--request-key", default="")
    dre.add_argument("--symbol", default="")
    dre.add_argument("--plugin", default="")
    dre.add_argument("--status", default="queued")
    dre.add_argument("--limit", type=int, default=1)
    dre.add_argument("--group-key", default="")
    dre.add_argument("--dry-run", action="store_true")
    dre.add_argument("--replace", action="store_true")
    dre.add_argument("--skip-compile", action="store_true")
    dre.add_argument("--fxdatabase-api-url", default="")
    dre.add_argument("--broker-source-id", default="")
    dre.add_argument("--source-origin", default="")
    dre.add_argument("--top-plugins", type=int, default=1)
    dre.add_argument("--limit-experiments", type=int, default=0)
    dre.add_argument("--limit-runs", type=int, default=0)
    dre.add_argument("--horizon", type=int, default=5)
    dre.add_argument("--m1sync-bars", type=int, default=3)
    dre.add_argument("--commission-per-lot-side", type=float, default=None)
    dre.add_argument("--cost-buffer-points", type=float, default=None)
    dre.add_argument("--slippage-points", type=float, default=None)
    dre.add_argument("--fill-penalty-points", type=float, default=None)
    dre.add_argument("--wf-train-bars", type=int, default=256)
    dre.add_argument("--wf-test-bars", type=int, default=64)
    dre.add_argument("--wf-purge-bars", type=int, default=32)
    dre.add_argument("--wf-embargo-bars", type=int, default=24)
    dre.add_argument("--wf-folds", type=int, default=6)
    dre.add_argument("--wf-test-years", type=float, default=0.25)
    dre.add_argument("--wf-purge-days", type=float, default=0.0)
    dre.add_argument("--wf-embargo-days", type=float, default=0.0)
    dre.add_argument("--wf-window-mode", choices=["rolling", "anchored"], default="rolling")
    dre.add_argument("--wf-bars-per-year", type=int, default=testlab.FX_M1_BARS_PER_TRADING_YEAR)
    dre.add_argument("--seed", type=int, default=42)
    dre.add_argument("--strategy-profile", default="default")
    dre.add_argument("--broker-profile", default="")
    dre.add_argument("--execution-profile", default="default", choices=sorted(testlab.EXECUTION_PROFILES.keys()))
    dre.add_argument("--login")
    dre.add_argument("--server")
    dre.add_argument("--password")
    dre.add_argument("--timeout", type=int, default=300)
    dre.set_defaults(func=cmd_drift_retraining_execute)
