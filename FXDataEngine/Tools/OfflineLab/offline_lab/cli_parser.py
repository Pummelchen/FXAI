...
def build_parser() -> argparse.ArgumentParser:
    ...
    tune.add_argument("--wf-train-years", type=float, default=0.0)
    tune.add_argument("--wf-test-years", type=float, default=0.0)
    tune.add_argument("--wf-purge-days", type=float, default=0.0)
