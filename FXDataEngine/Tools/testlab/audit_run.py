...
def write_audit_set(path: Path, args) -> None:
    ...
    content = "\n".join([
        ...
        f"Audit_Bars={args.bars}||2048||1||5000000||N",
        ...
        f"Audit_WalkForwardTrainBars={args.wf_train_bars}||64||1||5000000||N",
        f"Audit_WalkForwardTestBars={args.wf_test_bars}||16||1||5000000||N",
        f"Audit_WalkForwardPurgeBars={args.wf_purge_bars}||0||0||5000000||N",
        f"Audit_WalkForwardEmbargoBars={args.wf_embargo_bars}||0||0||5000000||N",
