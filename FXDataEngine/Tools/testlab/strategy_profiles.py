...
_KNOWN_OVERRIDE_MAP: dict[str, tuple[str, str]] = {
    ...
    "wf_train_years": ("audit", "wf_train_years"),
    "wf_test_years": ("audit", "wf_test_years"),
    "wf_purge_days": ("audit", "wf_purge_days"),
    "wf_embargo_days": ("audit", "wf_embargo_days"),
    "wf_window_mode": ("audit", "wf_window_mode"),
    "wf_bars_per_year": ("audit", "wf_bars_per_year"),
    "seed": ("audit", "seed"),
...
_KNOWN_AUDIT_FIELDS: tuple[tuple[str, tuple[str, str] | None, Any], ...] = (
    ...
    ("wf_train_years", ("audit", "wf_train_years"), 0.0),
    ("wf_test_years", ("audit", "wf_test_years"), 0.0),
    ("wf_purge_days", ("audit", "wf_purge_days"), 0.0),
    ("wf_embargo_days", ("audit", "wf_embargo_days"), 0.0),
    ("wf_window_mode", ("audit", "wf_window_mode"), "rolling"),
    ("wf_bars_per_year", ("audit", "wf_bars_per_year"), 374400),
