...
final class NormalizationStateTests: XCTestCase {
    ...
    func testMetaSupportNormalizationMethodCandidatesMatchLegacyOrdering() {
        ...
        XCTAssertEqual(AIModelID.nbeats.rawValue, 63)
        XCTAssertEqual(AIModelID.nhits.rawValue, 64)
        XCTAssertEqual(AIModelID.demoMovingAverageCross.rawValue, 65)
        XCTAssertEqual(AIModelID.demoFXStupid.rawValue, 66)
        XCTAssertEqual(AIModelID.demoFX7.rawValue, 67)
