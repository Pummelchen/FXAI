...
- `Lifecycle` and `Warmup`: partially ported. Warmup bucket scoring and portfolio-objective proxy math are in Swift; remaining warmup loops, plugin pretraining, lifecycle bootstrap/compliance/reset behavior, and agent orchestration still need conversion.
