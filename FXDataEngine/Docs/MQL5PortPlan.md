...
- `Runtime/Trade`: partially ported. Pure symbol/currency exposure helpers are in FXDataEngine; remaining broker position/order scanning, lifecycle execution, and risk lot sizing must be split between FXBacktest simulation and FXDataEngine policy/risk DTOs.
