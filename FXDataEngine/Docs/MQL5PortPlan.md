...
- Remaining in phase 5: `runtime_calendar_cache` feed/state reader, factor context state, and any lifecycle wiring that consumes macro/calendar availability.
