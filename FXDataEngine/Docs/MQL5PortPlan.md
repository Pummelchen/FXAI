...
- Remaining in phase 4: broader MTF dataset shaping/resampling, context-symbol range loading policy, and retained sample-window parity tests with no spread/tick dependency.
