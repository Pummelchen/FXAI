...
public struct AIAttnCNNBiLSTMPlugin: FXAIPlannedPlugin {
    private static let descriptor = FXAIPluginImplementationDescriptor.sequence(.attnCNNBiLSTM, "ai_attn_cnn_bilstm", .convolutional, [.tensorFlowMetal], [.pyTorchMPS, .coreMLNeuralEngine])
