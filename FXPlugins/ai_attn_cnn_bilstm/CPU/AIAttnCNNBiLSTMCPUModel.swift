...
public struct AIAttnCNNBiLSTMCPUModel: Sendable {
    ...
    private static let architectureID = 47
    private static let architectureMode = "attentionCNNBiLSTM"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.attnCNNBiLSTM.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
