...
public struct AINhitsPlugin: FXAIPlannedPlugin {
    private static let pluginManifest = PluginManifestV4(
        aiID: AIModelID.nhits.rawValue,
        aiName: "ai_nhits",
        family: .transformer,
        referenceTier: PluginPersistenceTools.defaultReferenceTier(aiID: AIModelID.nhits.rawValue),
    ...
    private var cpu: AINhitsCPUModel

    public var manifest: PluginManifestV4 { Self.pluginManifest }
    public var accelerationPlan: FXPluginAccelerationPlan { AINhitsAccelerated.descriptor }

    public init() {
        self.cpu = AINhitsCPUModel()
    }
