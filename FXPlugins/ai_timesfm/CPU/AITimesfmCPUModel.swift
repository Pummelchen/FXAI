...
public struct AITimesfmCPUModel: Sendable {
    ...
    private static let architectureID = 18
    private static let architectureMode = "foundationForecaster"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.timesfm.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
