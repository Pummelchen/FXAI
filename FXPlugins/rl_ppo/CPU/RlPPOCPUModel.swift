...
public struct RlPPOCPUModel: Sendable {
    ...
    private static let architectureID = 41
    private static let architectureMode = "ppoPolicy"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.rlPPO.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
