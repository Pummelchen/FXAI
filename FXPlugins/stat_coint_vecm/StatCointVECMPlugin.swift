...
public struct StatCointVECMPlugin: FXAIPlannedPlugin {
    private static let pluginManifest = PluginManifestV4(
        aiID: AIModelID.statCointVECM.rawValue,
        aiName: "stat_coint_vecm",
        family: .stateSpace,
        referenceTier: PluginPersistenceTools.defaultReferenceTier(aiID: AIModelID.statCointVECM.rawValue),
    ...
    private var cpu: StatCointVECMCPUModel

    public var manifest: PluginManifestV4 { Self.pluginManifest }
    public var accelerationPlan: FXPluginAccelerationPlan { StatCointVECMAccelerated.descriptor }

    public init() {
        self.cpu = StatCointVECMCPUModel()
    }
