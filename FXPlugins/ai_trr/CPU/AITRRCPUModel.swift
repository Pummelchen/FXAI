...
public struct AITRRCPUModel: Sendable {
    ...
    private static let architectureID = 24
    private static let architectureMode = "trendReversalRecurrent"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.trr.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
