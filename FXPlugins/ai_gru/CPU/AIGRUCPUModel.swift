...
public struct AIGRUCPUModel: Sendable {
    ...
    private static let architectureID = 58
    private static let architectureMode = "gru"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.gru.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
