...
public struct AIMythosRDTPlugin: FXAIPlannedPlugin {
    private static let pluginManifest = PluginManifestV4(
        aiID: AIModelID.mythosRDT.rawValue,
        aiName: "ai_mythos_rdt",
        family: .transformer,
        referenceTier: PluginPersistenceTools.defaultReferenceTier(aiID: AIModelID.mythosRDT.rawValue),
    ...
    private var cpu: AIMythosRDTCPUModel

    public var manifest: PluginManifestV4 { Self.pluginManifest }
    public var accelerationPlan: FXPluginAccelerationPlan { AIMythosRDTAccelerated.descriptor }

    public init() {
        self.cpu = AIMythosRDTCPUModel()
    }
