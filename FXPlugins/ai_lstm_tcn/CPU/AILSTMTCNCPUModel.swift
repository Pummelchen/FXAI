...
public struct AILSTMTCNCPUModel: Sendable {
    ...
    private static let architectureID = 60
    private static let architectureMode = "lstmTCN"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.lstmTCN.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
