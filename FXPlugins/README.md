...
- 29 full plugin-owned native conversions: `lin_sgd`, `lin_ftrl`, `lin_enhash`, `lin_pa`,
  ...
  `factor_cmv_panel`, plus `factor_pca_panel`, plus `trend_tsmom_vol` and `trend_xsmom_rank`,
...
- 30 Swift reference adapters for the remaining legacy plugins, each in its own plugin folder with
