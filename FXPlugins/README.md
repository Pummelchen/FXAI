...
- 21 full plugin-owned native conversions: `lin_sgd`, `lin_ftrl`, `lin_enhash`, `lin_pa`,
  ...
  `stat_ou_spread`, plus `stat_microflow_proxy` and `stat_hmm_regime`,
...
- 38 Swift reference adapters for the remaining legacy plugins, each in its own plugin folder with
