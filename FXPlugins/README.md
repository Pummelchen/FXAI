...
- 18 full plugin-owned native conversions: `lin_sgd`, `lin_ftrl`, `lin_enhash`, `lin_pa`,
  ...
  `tree_rf`, plus `stat_msgarch`, `stat_arimax_garch`, and `stat_coint_vecm`,
...
- 41 Swift reference adapters for the remaining legacy plugins, each in its own plugin folder with
