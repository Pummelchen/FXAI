...
public struct AICNNLSTMPlugin: FXAIPlannedPlugin {
    private static let descriptor = FXAIPluginImplementationDescriptor.sequence(.cnnLSTM, "ai_cnn_lstm", .convolutional, [.tensorFlowMetal], [.pyTorchMPS, .coreMLNeuralEngine])
