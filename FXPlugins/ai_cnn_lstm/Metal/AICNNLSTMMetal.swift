...
public enum AICNNLSTMMetal {
    public static let kernelSource = """
    #include <metal_stdlib>
    using namespace metal;

    kernel void ai_cnn_lstm_sequence_logits(
    ...
    kernel void ai_cnn_lstm_softmax3(
    ...
    public static let descriptor = FXPluginAccelerationPlan(
        ...
        notes: "Plugin-local Metal projection kernel source for ai_cnn_lstm. It is retained as non-runtime research code until full sequence-model parity kernels are implemented and verified against the Swift CPU and Python backends."
    )
}
