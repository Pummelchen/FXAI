...
public struct AIGeodesicCPUModel: Sendable {
    private static let featureCount = 32
    private static let hiddenCount = 20
    private static let architectureID = 5
    private static let architectureMode = "geodesicAttention"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.geodesicAttention.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
