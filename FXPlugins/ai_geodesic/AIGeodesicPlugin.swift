...
public struct AIGeodesicPlugin: FXAIPlannedPlugin {
    private static let descriptor = FXAIPluginImplementationDescriptor.sequence(.geodesicAttention, "ai_geodesic", .transformer, [.pyTorchMPS], [.metal, .coreMLNeuralEngine])
