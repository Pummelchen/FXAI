...
public struct AIFEWCCPUModel: Sendable {
    ...
    private static let architectureID = 33
    private static let architectureMode = "fewc"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.fewc.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
