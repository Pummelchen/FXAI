...
public enum AIFEWCMetal {
    public static let kernelSource = """
    #include <metal_stdlib>
    using namespace metal;

    kernel void ai_fewc_sequence_logits(
    ...
    public static let descriptor = FXPluginAccelerationPlan(
        ...
        notes: "Plugin-local Metal kernel source for ai_fewc batched feature projection and softmax inference. It is independent of the Swift CPU fallback and uses OHLCV feature tensors supplied by FXDataEngine."
    )
}
