...
| --- | --- | --- | --- |
| `ai_attn_cnn_bilstm` | Swift CPU sequence encoder plus live PyTorch/TensorFlow folders; Metal projection source retained as non-runtime research code. | Add golden attention-CNN-BiLSTM parity fixtures against the Python backends. | Keep PyTorch and TensorFlow as declared full neural backends; only declare Metal after full sequence-model parity kernels exist. |
| `ai_autoformer` | Swift CPU decomposition/autocorrelation encoder plus live PyTorch folder; Metal projection source retained as non-runtime research code. | Add long-horizon seasonality/decomposition golden fixtures. | Keep PyTorch Autoformer train/predict as declared backend; only declare Metal after full decomposition/autocorrelation parity kernels exist. |
...
| `ai_cnn_lstm` | Swift CPU convolution-recurrent encoder plus live PyTorch/TensorFlow folders; Metal projection source retained as non-runtime research code. | Add golden CNN-LSTM parity fixtures against the Python backends. | Keep PyTorch and TensorFlow CNN-LSTM as declared backends; only declare Metal after full convolution/recurrent parity kernels exist. |
...
| `ai_lstm` | Swift CPU gated recurrent encoder plus live PyTorch/TensorFlow folders; Metal projection source retained as non-runtime research code. | Add golden LSTM recurrent-state parity fixtures against the Python backends. | Keep PyTorch and TensorFlow LSTM as declared backends; only declare Metal after full recurrent parity kernels exist. |
| `ai_lstm_tcn` | Swift CPU temporal-convolution recurrent encoder plus live PyTorch/TensorFlow folders; Metal projection source retained as non-runtime research code. | Add hybrid TCN/LSTM golden parity fixtures against the Python backends. | Keep PyTorch and TensorFlow hybrid model as declared backends; only declare Metal after full TCN/recurrent parity kernels exist. |
| `ai_lstmg` | Swift CPU gated recurrent encoder plus live PyTorch/TensorFlow folders; Metal projection source retained as non-runtime research code. | Add LSTMG gate/state golden parity fixtures against the Python backends. | Keep PyTorch and TensorFlow LSTMG as declared backends; only declare Metal after full gate/recurrent parity kernels exist. |
...
| `ai_patchtst` | Swift CPU patch transformer encoder plus live PyTorch folder; Metal projection source retained as non-runtime research code. | Add patch extraction and transformer golden parity fixtures. | Keep PyTorch PatchTST as declared backend; only declare Metal after full patch/attention parity kernels exist. |
...
| `ai_tft` | Swift CPU attention/gating encoder plus live PyTorch folder; Metal projection source retained as non-runtime research code. | Add variable-selection and quantile golden parity fixtures. | Keep PyTorch Temporal Fusion Transformer as declared backend; only declare Metal after full gating/attention parity kernels exist. |
...
| `ai_tst` | Swift CPU transformer-style attention encoder plus live PyTorch folder; Metal projection source retained as non-runtime research code. | Add transformer attention golden parity fixtures. | Keep PyTorch transformer as declared backend; only declare Metal after full attention parity kernels exist. |
