...
public struct AITSTCPUModel: Sendable {
    private static let featureCount = 32
    private static let hiddenCount = 20
    private static let architectureID = 19
    private static let architectureMode = "transformer"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.tst.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
