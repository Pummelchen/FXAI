...
public struct WMGraphPlugin: FXAIPlannedPlugin {
    private static let pluginManifest = PluginManifestV4(
        aiID: AIModelID.graphWM.rawValue,
        aiName: "wm_graph",
        family: .worldModel,
        referenceTier: PluginPersistenceTools.defaultReferenceTier(aiID: AIModelID.graphWM.rawValue),
    ...
    private var cpu: WMGraphCPUModel

    public var manifest: PluginManifestV4 { Self.pluginManifest }
    public var accelerationPlan: FXPluginAccelerationPlan { WMGraphAccelerated.descriptor }

    public init() {
        self.cpu = WMGraphCPUModel()
    }
