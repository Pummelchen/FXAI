...
public struct WMCFXPlugin: FXAIPlannedPlugin {
    private static let pluginManifest = PluginManifestV4(
        aiID: AIModelID.cfxWorld.rawValue,
        aiName: "wm_cfx",
        family: .worldModel,
        referenceTier: PluginPersistenceTools.defaultReferenceTier(aiID: AIModelID.cfxWorld.rawValue),
    ...
    private var cpu: WMCFXCPUModel

    public var manifest: PluginManifestV4 { Self.pluginManifest }
    public var accelerationPlan: FXPluginAccelerationPlan { WMCFXAccelerated.descriptor }

    public init() {
        self.cpu = WMCFXCPUModel()
    }
