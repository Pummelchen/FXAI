...
public struct AIStmnCPUModel: Sendable {
    private static let featureCount = 32
    private static let hiddenCount = 18
    private static let architectureID = 15
    private static let architectureMode = "stmn"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.stmn.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
