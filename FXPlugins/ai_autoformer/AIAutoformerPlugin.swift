...
public struct AIAutoformerPlugin: FXAIPlannedPlugin {
    private static let descriptor = FXAIPluginImplementationDescriptor.sequence(.autoformer, "ai_autoformer", .transformer, [.pyTorchMPS], [.tensorFlowMetal, .coreMLNeuralEngine])
