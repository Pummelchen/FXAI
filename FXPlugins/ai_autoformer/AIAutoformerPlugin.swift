...
public struct AIAutoformerPlugin: FXAIPlannedPlugin {
    private static let pluginManifest = PluginManifestV4(
        aiID: AIModelID.autoformer.rawValue,
        aiName: "ai_autoformer",
        family: .transformer,
        referenceTier: PluginPersistenceTools.defaultReferenceTier(aiID: AIModelID.autoformer.rawValue),
    ...
    private var cpu: AIAutoformerCPUModel

    public var manifest: PluginManifestV4 { Self.pluginManifest }
    public var accelerationPlan: FXPluginAccelerationPlan { AIAutoformerAccelerated.descriptor }

    public init() {
        self.cpu = AIAutoformerCPUModel()
    }
