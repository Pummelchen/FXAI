...
public struct AIAutoformerCPUModel: Sendable {
    ...
    private static let architectureID = 0
    private static let architectureMode = "autoformer"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.autoformer.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
