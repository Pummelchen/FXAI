...
public struct AILSTMGCPUModel: Sendable {
    ...
    private static let architectureID = 8
    private static let architectureMode = "gatedRecurrent"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.lstmg.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
