...
public struct AITCNCPUModel: Sendable {
    private static let featureCount = 32
    private static let hiddenCount = 18
    private static let architectureID = 16
    private static let architectureMode = "tcn"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.tcn.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
