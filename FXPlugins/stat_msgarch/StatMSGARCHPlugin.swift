...
public struct StatMSGARCHPlugin: FXAIPlannedPlugin {
    private static let pluginManifest = PluginManifestV4(
        aiID: AIModelID.statMSGARCH.rawValue,
        aiName: "stat_msgarch",
        family: .stateSpace,
        referenceTier: PluginPersistenceTools.defaultReferenceTier(aiID: AIModelID.statMSGARCH.rawValue),
    ...
    private var cpu: StatMSGARCHCPUModel

    public var manifest: PluginManifestV4 { Self.pluginManifest }
    public var accelerationPlan: FXPluginAccelerationPlan { StatMSGARCHAccelerated.descriptor }

    public init() {
        self.cpu = StatMSGARCHCPUModel()
    }
