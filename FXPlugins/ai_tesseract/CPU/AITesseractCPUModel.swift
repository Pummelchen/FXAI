...
public struct AITesseractCPUModel: Sendable {
    ...
    private static let architectureID = 35
    private static let architectureMode = "tensorTesseract"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.tesseract.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
