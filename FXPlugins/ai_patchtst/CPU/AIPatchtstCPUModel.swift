...
public struct AIPatchtstCPUModel: Sendable {
    ...
    private static let architectureID = 11
    private static let architectureMode = "patchTransformer"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.patchTST.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
