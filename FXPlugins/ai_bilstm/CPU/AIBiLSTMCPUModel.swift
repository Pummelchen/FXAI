...
public struct AIBiLSTMCPUModel: Sendable {
    ...
    private static let architectureID = 59
    private static let architectureMode = "bidirectional"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.bilstm.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
