...
public struct AIQCEWCPUModel: Sendable {
    ...
    private static let architectureID = 32
    private static let architectureMode = "qcew"
    ...
    private static func seed(_ a: Int, _ b: Int) -> Double {
        sin(Double((AIModelID.qcew.rawValue + 31) * (a + 3) * 67 + (b + 11) * 131 + Self.architectureID * 17))
    }
}
