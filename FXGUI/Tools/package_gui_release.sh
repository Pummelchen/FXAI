...
VERSION="${2:-${FXGUI_VERSION:-0.7.0}}"
APP_NAME="FXGUI"
BUNDLE_NAME="FXGUI.app"
BUILD_DIR="${GUI_ROOT}/.build/release"
EXECUTABLE_PATH="${BUILD_DIR}/FXGUI"
...
MINIMUM_MACOS="${FXGUI_MINIMUM_MACOS:-${GUI_CONFIG[1]:-14.0}}"
ARCHIVE_NAME="${FXGUI_RELEASE_ARCHIVE:-${GUI_CONFIG[2]:-FXGUI-macos.zip}}"
ARCHIVE_PATH="${OUTPUT_ROOT}/${ARCHIVE_NAME}"

mkdir -p "${OUTPUT_ROOT}"

printf 'Building FXGUI in release mode...\n'
...
cp "${EXECUTABLE_PATH}" "${MACOS_DIR}/FXGUI"
chmod +x "${MACOS_DIR}/FXGUI"
