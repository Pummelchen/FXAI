...
- flat Swift plugin zoo folders under `FXPlugins/<plugin_id>/`, with shared access code under `FXPlugins/API/`
...
- `FXGUICore/Services/RunBuilderCommandFactory.swift`
...
- `FXGUICore/Services/RuntimeArtifactReader.swift`
- `FXGUICore/Models/RuntimeArtifactModels.swift`
...
- `FXGUICore/Services/ResearchOSArtifactReader.swift`
- `FXGUICore/Services/ResearchOSCommandFactory.swift`
- `FXGUICore/Models/ResearchOSControlModels.swift`
...
- `FXGUICore/Services/AdvancedVisualizationBuilder.swift`
- `FXGUICore/Models/AdvancedVisualizationModels.swift`
...
- `FXGUICore/Services/SavedWorkspaceStore.swift`
- `FXGUICore/Services/IncidentBuilder.swift`
- `FXGUICore/Services/OnboardingGuideFactory.swift`
- `FXGUI/Tools/package_gui_release.sh`
