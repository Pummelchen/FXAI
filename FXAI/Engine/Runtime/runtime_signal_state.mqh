...
struct FXAIRuntimeSignalCache
{
   ...
   bool execution_quality_ready;
   bool execution_quality_fallback_used;
   bool execution_quality_memory_stale;
   bool execution_quality_data_stale;
   bool execution_quality_support_usable;
   datetime execution_quality_generated_at;
   string execution_quality_method;
   string execution_quality_tier_kind;
   string execution_quality_tier_key;
   int execution_quality_support;
   double execution_quality_quality;
   double execution_quality_spread_now;
   double execution_quality_spread_expected;
   double execution_quality_spread_widening_risk;
   double execution_quality_expected_slippage;
   double execution_quality_slippage_risk;
   double execution_quality_fill_quality;
   double execution_quality_latency_sensitivity;
   double execution_quality_liquidity_fragility;
   double execution_quality_quality_score;
   double execution_quality_allowed_deviation;
   double execution_quality_caution_lot_scale;
   double execution_quality_caution_enter_prob_buffer;
   string execution_quality_state;
   string execution_quality_reasons_csv;
...
void FXAI_RuntimeCaptureSignalCache(FXAIRuntimeSignalCache &out)
{
   ...
   out.execution_quality_ready = g_execution_quality_last_ready;
   out.execution_quality_fallback_used = g_execution_quality_last_fallback_used;
   out.execution_quality_memory_stale = g_execution_quality_last_memory_stale;
   out.execution_quality_data_stale = g_execution_quality_last_data_stale;
   out.execution_quality_support_usable = g_execution_quality_last_support_usable;
   out.execution_quality_generated_at = g_execution_quality_last_generated_at;
   out.execution_quality_method = g_execution_quality_last_method;
   out.execution_quality_tier_kind = g_execution_quality_last_tier_kind;
   out.execution_quality_tier_key = g_execution_quality_last_tier_key;
   out.execution_quality_support = g_execution_quality_last_support;
   out.execution_quality_quality = g_execution_quality_last_quality;
   out.execution_quality_spread_now = g_execution_quality_last_spread_now;
   out.execution_quality_spread_expected = g_execution_quality_last_spread_expected;
   out.execution_quality_spread_widening_risk = g_execution_quality_last_spread_widening_risk;
   out.execution_quality_expected_slippage = g_execution_quality_last_expected_slippage;
   out.execution_quality_slippage_risk = g_execution_quality_last_slippage_risk;
   out.execution_quality_fill_quality = g_execution_quality_last_fill_quality;
   out.execution_quality_latency_sensitivity = g_execution_quality_last_latency_sensitivity;
   out.execution_quality_liquidity_fragility = g_execution_quality_last_liquidity_fragility;
   out.execution_quality_quality_score = g_execution_quality_last_quality_score;
   out.execution_quality_allowed_deviation = g_execution_quality_last_allowed_deviation;
   out.execution_quality_caution_lot_scale = g_execution_quality_last_caution_lot_scale;
   out.execution_quality_caution_enter_prob_buffer = g_execution_quality_last_caution_enter_prob_buffer;
   out.execution_quality_state = g_execution_quality_last_state;
   out.execution_quality_reasons_csv = g_execution_quality_last_reasons_csv;
...
void FXAI_RuntimeRestoreSignalCache(const FXAIRuntimeSignalCache &cache)
{
   ...
   g_execution_quality_last_ready = cache.execution_quality_ready;
   g_execution_quality_last_fallback_used = cache.execution_quality_fallback_used;
   g_execution_quality_last_memory_stale = cache.execution_quality_memory_stale;
   g_execution_quality_last_data_stale = cache.execution_quality_data_stale;
   g_execution_quality_last_support_usable = cache.execution_quality_support_usable;
   g_execution_quality_last_generated_at = cache.execution_quality_generated_at;
   g_execution_quality_last_method = cache.execution_quality_method;
   g_execution_quality_last_tier_kind = cache.execution_quality_tier_kind;
   g_execution_quality_last_tier_key = cache.execution_quality_tier_key;
   g_execution_quality_last_support = cache.execution_quality_support;
   g_execution_quality_last_quality = cache.execution_quality_quality;
   g_execution_quality_last_spread_now = cache.execution_quality_spread_now;
   g_execution_quality_last_spread_expected = cache.execution_quality_spread_expected;
   g_execution_quality_last_spread_widening_risk = cache.execution_quality_spread_widening_risk;
   g_execution_quality_last_expected_slippage = cache.execution_quality_expected_slippage;
   g_execution_quality_last_slippage_risk = cache.execution_quality_slippage_risk;
   g_execution_quality_last_fill_quality = cache.execution_quality_fill_quality;
   g_execution_quality_last_latency_sensitivity = cache.execution_quality_latency_sensitivity;
   g_execution_quality_last_liquidity_fragility = cache.execution_quality_liquidity_fragility;
   g_execution_quality_last_quality_score = cache.execution_quality_quality_score;
   g_execution_quality_last_allowed_deviation = cache.execution_quality_allowed_deviation;
   g_execution_quality_last_caution_lot_scale = cache.execution_quality_caution_lot_scale;
   g_execution_quality_last_caution_enter_prob_buffer = cache.execution_quality_caution_enter_prob_buffer;
   g_execution_quality_last_state = cache.execution_quality_state;
   g_execution_quality_last_reasons_csv = cache.execution_quality_reasons_csv;
