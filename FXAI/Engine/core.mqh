...
enum ENUM_AI_TYPE
{
   ...
   AI_TESSERACT,
   AI_STAT_MSGARCH,
   AI_STAT_ARIMAX_GARCH,
   AI_TREE_RF,
   AI_STAT_COINT_VECM,
   AI_STAT_OU_SPREAD,
   AI_RL_PPO,
   AI_STAT_MICROFLOW_PROXY,
   AI_STAT_HMM_REGIME,
   AI_LIN_ELASTIC_LOGIT,
   AI_LIN_PROFIT_LOGIT,
   AI_CNN_LSTM,
   AI_ATTN_CNN_BILSTM,
   AI_STAT_EMD_HHT,
...
int FXAI_DefaultReferenceTierForAI(const int ai_id)
{
   switch(ai_id)
   {
      ...
      case AI_TCN:
      case AI_TFT:
      case AI_STAT_MSGARCH:
      case AI_STAT_ARIMAX_GARCH:
      case AI_TREE_RF:
      case AI_STAT_COINT_VECM:
      case AI_STAT_OU_SPREAD:
      case AI_RL_PPO:
      case AI_STAT_MICROFLOW_PROXY:
      case AI_STAT_HMM_REGIME:
      case AI_CNN_LSTM:
      case AI_ATTN_CNN_BILSTM:
      case AI_STAT_EMD_HHT:
      case AI_STAT_VMD:
      case AI_STAT_TVP_KALMAN:
      case AI_FACTOR_PCA_PANEL:
      case AI_FACTOR_PPP_VALUE:
      case AI_FACTOR_CARRY:
      case AI_FACTOR_CMV_PANEL:
      case AI_TREND_TSMOM_VOL:
      case AI_TREND_XSMOM_RANK:
      case AI_TREND_VOL_BREAKOUT:
      case AI_STAT_XRATE_CONSISTENCY:
      case AI_GRU:
      case AI_BILSTM:
      case AI_LSTM_TCN:
      ...
      case AI_PA_LINEAR:
      case AI_SGD_LOGIT:
      case AI_LIN_ELASTIC_LOGIT:
      case AI_LIN_PROFIT_LOGIT:
