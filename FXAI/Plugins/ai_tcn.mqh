...
private:
   ...
   double m_w_conv1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN][FXAI_TCN_MAX_KERNEL];
   double m_b_conv1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   double m_w_conv2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN][FXAI_TCN_MAX_KERNEL];
   double m_b_conv2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   // 1x1 residual projection + gating.
   double m_w_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
   double m_b_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   double m_w_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
   double m_b_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   // Learnable normalization affine params.
   double m_g1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_bn1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_g2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_bn2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   // Output heads: 3-class + distributional move.
   double m_w_cls[FXAI_TCN_CLASS_COUNT][FXAI_AI_MLP_HIDDEN];
   double m_b_cls[FXAI_TCN_CLASS_COUNT];
   ...
   double m_hist_stream[FXAI_TCN_MAX_LAYERS + 1][FXAI_TCN_HIST][FXAI_AI_MLP_HIDDEN];
   // Mid activations after conv1/tanh/dropout for conv2 temporal taps.
   double m_hist_mid[FXAI_TCN_MAX_LAYERS][FXAI_TCN_HIST][FXAI_AI_MLP_HIDDEN];

   // TBPTT sequence buffers.
   int    m_seq_len;
   double m_seq_x[FXAI_TCN_TBPTT][FXAI_AI_WEIGHTS];
   int    m_seq_cls[FXAI_TCN_TBPTT];
   double m_seq_move[FXAI_TCN_TBPTT];
   double m_seq_cost[FXAI_TCN_TBPTT];
   double m_seq_w[FXAI_TCN_TBPTT];

   // Forward caches per sequence step.
   double m_seq_in[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_seq_n1[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_seq_a1[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_seq_drop[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_seq_n2[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_seq_pre[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_seq_gate[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_seq_out[FXAI_TCN_TBPTT][FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   double m_seq_final[FXAI_TCN_TBPTT][FXAI_AI_MLP_HIDDEN];
   double m_seq_logits[FXAI_TCN_TBPTT][FXAI_TCN_CLASS_COUNT];
   double m_seq_probs[FXAI_TCN_TBPTT][FXAI_TCN_CLASS_COUNT];
   double m_seq_mu[FXAI_TCN_TBPTT];
   double m_seq_logv[FXAI_TCN_TBPTT];
   double m_seq_q25[FXAI_TCN_TBPTT];
   double m_seq_q75[FXAI_TCN_TBPTT];

   // RMSProp states (conv kernels/biases).
   double m_r_w_conv1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN][FXAI_TCN_MAX_KERNEL];
   double m_r_b_conv1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_r_w_conv2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN][FXAI_TCN_MAX_KERNEL];
   double m_r_b_conv2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   // AdamW states (all other params).
   double m_m_w_in[FXAI_AI_MLP_HIDDEN][FXAI_AI_WEIGHTS], m_v_w_in[FXAI_AI_MLP_HIDDEN][FXAI_AI_WEIGHTS];
   double m_m_b_in[FXAI_AI_MLP_HIDDEN], m_v_b_in[FXAI_AI_MLP_HIDDEN];

   double m_m_w_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
   double m_v_w_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
   double m_m_b_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN], m_v_b_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   double m_m_w_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
   double m_v_w_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
   double m_m_b_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN], m_v_b_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   double m_m_g1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN], m_v_g1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_m_bn1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN], m_v_bn1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_m_g2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN], m_v_g2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
   double m_m_bn2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN], m_v_bn2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

   double m_m_w_cls[FXAI_TCN_CLASS_COUNT][FXAI_AI_MLP_HIDDEN], m_v_w_cls[FXAI_TCN_CLASS_COUNT][FXAI_AI_MLP_HIDDEN];
   double m_m_b_cls[FXAI_TCN_CLASS_COUNT], m_v_b_cls[FXAI_TCN_CLASS_COUNT];
   ...
   {
      int p = base - back;
      while(p < 0) p += FXAI_TCN_HIST;
      while(p >= FXAI_TCN_HIST) p -= FXAI_TCN_HIST;
      return p;
   }
   ...
   int DilationAtLayer(const int l) const
   {
      ...
      for(int i=0; i<l; i++)
      {
         if(d > FXAI_TCN_HIST / m_dbase) return FXAI_TCN_HIST;
         d *= m_dbase;
      }
      return d;
   }
   ...
   {
      double ss = 0.0;
      for(int i=0; i<FXAI_AI_MLP_HIDDEN; i++) ss += v[i] * v[i];
      double inv = 1.0 / MathSqrt(ss / (double)FXAI_AI_MLP_HIDDEN + 1e-6);
   ...
   {
      m_seq_len = 0;
      for(int t=0; t<FXAI_TCN_TBPTT; t++)
      {
         m_seq_cls[t] = FXAI_TCN_SKIP;
         m_seq_move[t] = 0.0;
         m_seq_cost[t] = 0.0;
         m_seq_w[t] = 1.0;
         m_seq_mu[t] = 0.0;
         ...
         for(int c=0; c<FXAI_TCN_CLASS_COUNT; c++)
         {
   ...
   void ResetOptimizers(void)
   {
      ...
      for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
      {
         ...
         for(int cls=0; cls<FXAI_TCN_CLASS_COUNT; cls++)
         {
            m_m_w_cls[cls][c] = 0.0;
            m_v_w_cls[cls][c] = 0.0;
         }
      ...
      for(int l=0; l<FXAI_TCN_MAX_LAYERS; l++)
      {
         for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
         {
            ...
            for(int j=0; j<FXAI_AI_MLP_HIDDEN; j++)
            {
               ...
               for(int k=0; k<FXAI_TCN_MAX_KERNEL; k++)
               {
   ...
   void ApplyConfig(const FXAIAIHyperParams &hp)
   {
      int layers = CfgI(hp.tcn_layers, 4, 2, FXAI_TCN_MAX_LAYERS);
      int kernel = CfgI(hp.tcn_kernel, 3, 2, FXAI_TCN_MAX_KERNEL);
      ...
      while(use_layers > 2)
      {
         ...
         for(int l=0; l<use_layers; l++)
         {
            ...
            if(l + 1 < use_layers)
            {
               if(d > FXAI_TCN_HIST / MathMax(dbase, 1)) d = FXAI_TCN_HIST;
               else d *= dbase;
            }
         }
         if(receptive <= FXAI_TCN_HIST) break;
         use_layers--;
      }
      ...
      m_lr = FXAI_Clamp(hp.lr, 0.00005, 0.25000);
      m_l2 = FXAI_Clamp(hp.l2, 0.00000, 0.20000);
      m_wd = FXAI_Clamp(0.25 * m_l2, 0.0, 0.05);
      m_beta1 = 0.90;
      m_beta2 = 0.999;
      m_rms_decay = 0.99;
      m_drop_rate = FXAI_Clamp(0.02 + 0.15 * m_l2, 0.0, 0.20);
   ...
   {
      if(y == FXAI_TCN_SELL || y == FXAI_TCN_BUY || y == FXAI_TCN_SKIP)
         return y;

      double cost = InputCostProxyPoints(x);
      double edge = MathAbs(move_points) - cost;
      double skip_band = 0.10 + 0.25 * cost;
      if(edge <= skip_band) return FXAI_TCN_SKIP;

      if(y > 0) return FXAI_TCN_BUY;
      if(y == 0) return FXAI_TCN_SELL;
      return (move_points >= 0.0 ? FXAI_TCN_BUY : FXAI_TCN_SELL);
   }
   ...
   void InitWeights(void)
   {
      ...
      for(int l=0; l<FXAI_TCN_MAX_LAYERS; l++)
      {
         for(int oc=0; oc<FXAI_AI_MLP_HIDDEN; oc++)
         {
            for(int ic=0; ic<FXAI_AI_MLP_HIDDEN; ic++)
            {
   ...
   void ForwardStep(const double &x[],
                    ...
                    double &h_last[])
   {
      int ptr_new = (m_ptr + 1) % FXAI_TCN_HIST;

      double curr[FXAI_AI_MLP_HIDDEN];
      for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
      {
         double s = m_b_in[c];
         for(int i=0; i<FXAI_AI_WEIGHTS; i++)
            s += m_w_in[c][i] * x[i];
         curr[c] = FXAI_Tanh(FXAI_ClipSym(s, 8.0));
      }
      ...
      double skip_acc[FXAI_AI_MLP_HIDDEN];
      for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++) skip_acc[c] = 0.0;

      for(int l=0; l<m_layers; l++)
      {
         double in_vec[FXAI_AI_MLP_HIDDEN];
         double n1[FXAI_AI_MLP_HIDDEN];
         double a1[FXAI_AI_MLP_HIDDEN];
         double drop_mask[FXAI_AI_MLP_HIDDEN];
         double n2[FXAI_AI_MLP_HIDDEN];
         double gate[FXAI_AI_MLP_HIDDEN];
         double pre[FXAI_AI_MLP_HIDDEN];
         double out[FXAI_AI_MLP_HIDDEN];

         for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
            in_vec[c] = curr[c];

         double g1v[FXAI_AI_MLP_HIDDEN], b1v[FXAI_AI_MLP_HIDDEN];
         for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
         {
            g1v[c] = m_g1[l][c];
            b1v[c] = m_bn1[l][c];
         ...
         for(int oc=0; oc<FXAI_AI_MLP_HIDDEN; oc++)
         {
            ...
            a1[oc] = FXAI_Tanh(FXAI_ClipSym(s, 8.0));
         ...
         double g2v[FXAI_AI_MLP_HIDDEN], b2v[FXAI_AI_MLP_HIDDEN];
         for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
         {
            g2v[c] = m_g2[l][c];
            b2v[c] = m_bn2[l][c];
         ...
         for(int oc=0; oc<FXAI_AI_MLP_HIDDEN; oc++)
         {
            ...
            pre[oc] = r + c2;
            gate[oc] = g;
            out[oc] = FXAI_Tanh(FXAI_ClipSym(in_vec[oc] + g * pre[oc], 8.0));
            skip_acc[oc] += out[oc];
         }
         ...
         if(seq_t >= 0 && seq_t < FXAI_TCN_TBPTT)
         {
            for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
            {
      ...
      for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
      {
         ...
         h_last[c] = FXAI_ClipSym(z, 8.0);
      }

      if(commit)
      {
         m_ptr = ptr_new;
         if(m_hist_len < FXAI_TCN_HIST) m_hist_len++;
      }
   }
   ...
   {
      if(m_seq_len >= FXAI_TCN_TBPTT) return;
      ...
      double logits_t[FXAI_TCN_CLASS_COUNT];
      double probs_t[FXAI_TCN_CLASS_COUNT];
      ...
      double den = m_seq_probs[t][FXAI_TCN_BUY] + m_seq_probs[t][FXAI_TCN_SELL];
      if(den < 1e-9) den = 1e-9;
      double p_dir = m_seq_probs[t][FXAI_TCN_BUY] / den;
      if(cls != FXAI_TCN_SKIP)
      {
         int y_dir = (cls == FXAI_TCN_BUY ? 1 : 0);
   ...
   void TrainTBPTT(const FXAIAIHyperParams &hp)
   {
      ...
      double lr = FXAI_Clamp(m_lr, 0.00005, 0.25000) / MathSqrt(1.0 + 0.0005 * (double)m_step);
      double lr_head = FXAI_Clamp(1.05 * lr, 0.00002, 0.20000);
      double lr_core = FXAI_Clamp(0.80 * lr, 0.00002, 0.15000);

      // Gradient accumulators.
      double g_w_in[FXAI_AI_MLP_HIDDEN][FXAI_AI_WEIGHTS];
      double g_b_in[FXAI_AI_MLP_HIDDEN];

      double g_w_conv1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN][FXAI_TCN_MAX_KERNEL];
      double g_b_conv1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
      double g_w_conv2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN][FXAI_TCN_MAX_KERNEL];
      double g_b_conv2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

      double g_w_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
      double g_b_res[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
      double g_w_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN][FXAI_AI_MLP_HIDDEN];
      double g_b_gate[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

      double g_g1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
      double g_bn1[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
      double g_g2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];
      double g_bn2[FXAI_TCN_MAX_LAYERS][FXAI_AI_MLP_HIDDEN];

      double g_w_cls[FXAI_TCN_CLASS_COUNT][FXAI_AI_MLP_HIDDEN];
      double g_b_cls[FXAI_TCN_CLASS_COUNT];
      ...
      for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
      {
         ...
         g_w_q25[c] = 0.0;
         g_w_q75[c] = 0.0;
         for(int i=0; i<FXAI_AI_WEIGHTS; i++) g_w_in[c][i] = 0.0;
         for(int cls=0; cls<FXAI_TCN_CLASS_COUNT; cls++) g_w_cls[cls][c] = 0.0;
      }
      g_b_mu = 0.0; g_b_logv = 0.0; g_b_q25 = 0.0; g_b_q75 = 0.0;
      for(int cls=0; cls<FXAI_TCN_CLASS_COUNT; cls++) g_b_cls[cls] = 0.0;
      ...
      for(int t=T - 1; t>=0; t--)
      {
         ...
         double dlogit[FXAI_TCN_CLASS_COUNT];
         for(int k=0; k<FXAI_TCN_CLASS_COUNT; k++)
         {
         ...
         inv_var = FXAI_Clamp(inv_var, 0.02, 50.0);
         ...
         for(int l=m_layers - 1; l>=0; l--)
         {
            ...
            double d_in[FXAI_AI_MLP_HIDDEN];
            double d_n1[FXAI_AI_MLP_HIDDEN];
            double d_a1[FXAI_AI_MLP_HIDDEN];
            double d_n2[FXAI_AI_MLP_HIDDEN];
            for(int i=0; i<FXAI_AI_MLP_HIDDEN; i++)
            {
               d_in[i] = 0.0;
               d_n1[i] = 0.0;
            ...
            double inv2 = 1.0 / MathSqrt(ss2 / (double)FXAI_AI_MLP_HIDDEN + 1e-6);
            double inv2_cub = inv2 * inv2 * inv2;

            double dzn2[FXAI_AI_MLP_HIDDEN];
            double dot2 = 0.0;
            for(int ic=0; ic<FXAI_AI_MLP_HIDDEN; ic++)
            {
            ...
            {
               double xv = m_seq_a1[t][l][ic];
               d_a1[ic] += dzn2[ic] * inv2 - xv * dot2 * (inv2_cub / (double)FXAI_AI_MLP_HIDDEN);
            }
            ...
            double inv1 = 1.0 / MathSqrt(ss1 / (double)FXAI_AI_MLP_HIDDEN + 1e-6);
            double inv1_cub = inv1 * inv1 * inv1;

            double dzn1[FXAI_AI_MLP_HIDDEN];
            double dot1 = 0.0;
            for(int ic=0; ic<FXAI_AI_MLP_HIDDEN; ic++)
            {
            ...
            {
               double xv = m_seq_in[t][l][ic];
               d_in[ic] += dzn1[ic] * inv1 - xv * dot1 * (inv1_cub / (double)FXAI_AI_MLP_HIDDEN);
            }
      ...
      for(int cls=0; cls<FXAI_TCN_CLASS_COUNT; cls++) g2 += g_b_cls[cls] * g_b_cls[cls];
      ...
      if(gscale < 1.0)
      {
         for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
         {
            ...
            g_w_q25[c] *= gscale;
            g_w_q75[c] *= gscale;
            for(int i=0; i<FXAI_AI_WEIGHTS; i++) g_w_in[c][i] *= gscale;
            for(int cls=0; cls<FXAI_TCN_CLASS_COUNT; cls++) g_w_cls[cls][c] *= gscale;
         }
         ...
         g_b_q25 *= gscale;
         g_b_q75 *= gscale;
         for(int cls=0; cls<FXAI_TCN_CLASS_COUNT; cls++) g_b_cls[cls] *= gscale;
      ...
      for(int l=0; l<m_layers; l++)
      {
         for(int oc=0; oc<FXAI_AI_MLP_HIDDEN; oc++)
         {
            ...
            for(int ic=0; ic<FXAI_AI_MLP_HIDDEN; ic++)
            {
               ...
               m_w_res[l][oc][ic] = FXAI_ClipSym(m_w_res[l][oc][ic], 5.0);
               m_w_gate[l][oc][ic] = FXAI_ClipSym(m_w_gate[l][oc][ic], 5.0);
            }
            ...
            m_g1[l][oc] = FXAI_Clamp(m_g1[l][oc], 0.10, 6.0);
            m_g2[l][oc] = FXAI_Clamp(m_g2[l][oc], 0.10, 6.0);
            m_bn1[l][oc] = FXAI_ClipSym(m_bn1[l][oc], 4.0);
            m_bn2[l][oc] = FXAI_ClipSym(m_bn2[l][oc], 4.0);
         }
      }
      ...
      for(int c=0; c<FXAI_AI_MLP_HIDDEN; c++)
      {
         ...
         m_w_mu[c] = FXAI_ClipSym(m_w_mu[c], 6.0);
         m_w_logv[c] = FXAI_ClipSym(m_w_logv[c], 6.0);
         m_w_q25[c] = FXAI_ClipSym(m_w_q25[c], 6.0);
         m_w_q75[c] = FXAI_ClipSym(m_w_q75[c], 6.0);
      }

      for(int cls=0; cls<FXAI_TCN_CLASS_COUNT; cls++)
      {
         AdamWUpdate(m_b_cls[cls], m_m_b_cls[cls], m_v_b_cls[cls], g_b_cls[cls], lr_head, m_beta1, m_beta2, 0.0, tstep);
         m_b_cls[cls] = FXAI_ClipSym(m_b_cls[cls], 6.0);
      }
      ...
      m_b_mu = FXAI_ClipSym(m_b_mu, 10.0);
      m_b_logv = FXAI_Clamp(m_b_logv, -4.0, 4.0);
      m_b_q25 = FXAI_ClipSym(m_b_q25, 10.0);
      m_b_q75 = FXAI_ClipSym(m_b_q75, 10.0);
