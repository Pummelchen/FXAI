...
- root-level `../FXDataEngineGUI/Sources/FXAIGUICore`, `../FXDataEngineGUI/Sources/FXAIGUIApp`
...
- GUI source of truth: root-level `FXDataEngineGUI/` inside the versioned repo
