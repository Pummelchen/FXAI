#ifndef __FXAI_AUDIT_CONTEXT_SERIES_MQH__
#define __FXAI_AUDIT_CONTEXT_SERIES_MQH__
                                      ...
                                      double &ctx_extra_arr[])
{
   ...
   for(int k=0; k<bars; k++)
   {
      ...
      double persistence_bias = (persistence - 0.50) * (0.35 - 0.18 * mean_revert_bias) * MathAbs(prev_ret);
      if(prev_ret >= 0.0)
...
#endif // __FXAI_AUDIT_CONTEXT_SERIES_MQH__
