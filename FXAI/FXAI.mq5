...
bool     g_prob_calibration_last_ready = false;
bool     g_prob_calibration_last_fallback_used = false;
bool     g_prob_calibration_last_abstain = false;
bool     g_prob_calibration_last_calibration_stale = true;
bool     g_prob_calibration_last_input_stale = true;
datetime g_prob_calibration_last_generated_at = 0;
string   g_prob_calibration_last_method = "LOGISTIC_AFFINE";
string   g_prob_calibration_last_tier_kind = "GLOBAL";
string   g_prob_calibration_last_tier_key = "GLOBAL|*|*|*";
int      g_prob_calibration_last_support = 0;
double   g_prob_calibration_last_quality = 0.0;
double   g_prob_calibration_last_raw_score = 0.0;
string   g_prob_calibration_last_raw_action = "SKIP";
double   g_prob_calibration_last_raw_buy_prob = 0.0;
double   g_prob_calibration_last_raw_sell_prob = 0.0;
double   g_prob_calibration_last_raw_skip_prob = 1.0;
double   g_prob_calibration_last_buy_prob = 0.0;
double   g_prob_calibration_last_sell_prob = 0.0;
double   g_prob_calibration_last_skip_prob = 1.0;
double   g_prob_calibration_last_confidence = 0.0;
double   g_prob_calibration_last_move_mean = 0.0;
double   g_prob_calibration_last_move_q25 = 0.0;
double   g_prob_calibration_last_move_q50 = 0.0;
double   g_prob_calibration_last_move_q75 = 0.0;
double   g_prob_calibration_last_spread_cost = 0.0;
double   g_prob_calibration_last_slippage_cost = 0.0;
double   g_prob_calibration_last_uncertainty_score = 0.0;
double   g_prob_calibration_last_uncertainty_penalty = 0.0;
double   g_prob_calibration_last_risk_penalty = 0.0;
double   g_prob_calibration_last_gross_edge = 0.0;
double   g_prob_calibration_last_edge_after_costs = 0.0;
string   g_prob_calibration_last_final_action = "SKIP";
string   g_prob_calibration_last_session = "UNKNOWN";
