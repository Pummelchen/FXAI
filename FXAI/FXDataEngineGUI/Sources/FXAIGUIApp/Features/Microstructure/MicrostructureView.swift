        ...
        VStack(alignment: .leading, spacing: 16) {
            if let selectedSymbol {
                ...
                LazyVGrid(columns: [GridItem(.adaptive(minimum: 200), spacing: 12, alignment: .top)], spacing: 12) {
                    ...
                    detailMetric(title: "Price Cost Z-Score 60s", value: optionalDoubleString(selectedSymbol.priceCostZScore60s), tint: FXAITheme.warning)
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    metricRow(label: "Session Price Cost", value: percentString(selectedSymbol.sessionPriceCostBehaviorScore))
                    metricRow(label: "Price Cost Current", value: optionalDoubleString(selectedSymbol.priceCostCurrent))
