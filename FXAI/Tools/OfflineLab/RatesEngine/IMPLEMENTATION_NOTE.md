...
- GUI integration follows the existing artifact-reader pattern under `<FXAI_ROOT>/FXDataEngineGUI/Sources/FXAIGUICore/Services` and `<FXAI_ROOT>/FXDataEngineGUI/Sources/FXAIGUIApp/Features`.
